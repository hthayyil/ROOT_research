#include "TMath.h"
void lambdaSameCharge(){


		TH1D *mass2 = new TH1D ("mass2", "Proton-Pion", 400, 1,1.4);
		//Load the file
		TH1D *mass2 = new TH1D ("mass2", "Proton-Pion", 400, 1.08,1.15);
...
file= new TFile("lambdaSameCharge.root","RECREATE");
mass2-> Write();

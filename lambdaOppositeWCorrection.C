...
#include "TMath.h"
void lambdaOppositeWCorrection(){
		...
		TFile *f = TFile::Open("withDecay_CUETP8M1_NEvt100000_DoFlatPthatTrue_FlatPower4p50_PthatMin40p0_PthatMax999999p0_20181120.root");
		 TH1D *mass = new TH1D ("mass", "Lambda Opposite Charge Mass Reconstruction with Correction", 400, 1.08,1.15);
...
cout << nEvent<<endl;
	...
	file= new TFile("lambdaOppositeWCorrection.root","RECREATE");
	mass-> Write();

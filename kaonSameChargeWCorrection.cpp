#include "TMath.h"
void kaonSameChargeWCorrection(){
		...
		TH1D *mass2 = new TH1D ("mass2", "Kaon Same Charge Mass Reconstruction with Correction", 400, 0.48,0.52);
...
file= new TFile("kaonSameChargeWithCorrection.root","RECREATE");
mass2-> Write();

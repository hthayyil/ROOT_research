#include "TMath.h"
void lambdaSameChargePDG(){


		TH1D *mass2 = new TH1D ("mass2", "Lambda Same Charge Mass Reconstruction", 400, 1.08,1.15);
		//Load the file
...
file= new TFile("lambdaSameChargePDG.root","RECREATE");
mass2-> Write();

...
void lambdaOppositeCharge(){
		...
		//Load the file
		TFile *f = TFile::Open("part5_CUETP8M1_NEvt200000_DoFlatPthatTrue_FlatPower4p50_PthatMin120p0_PthatMax999999p0_20181016.root");
		
		 TH1D *mass = new TH1D ("mass", "Proton-Pion", 400, 1,1.4);
...
cout << nEvent<<endl;
	...
	file= new TFile("lambdaOppositeCharge.root","RECREATE");
	mass-> Write();
